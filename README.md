<p align="center">
<img src="https://github.com/mihaiyle/MZ-GPU-Miner/assets/46845936/a098a772-a464-4ae1-bfac-e42e0380bcd3"
</p>

## MZ GPU Miner
GPU Miner for `ETH`, `RVN`, `BEAM`, `CFX`, `ZIL`, `ERGO`, `AE`, `VRSC`, `XMR`

## Contact Us:
* Email MZ Miner: mzmining@gmail.com
* Email Support Team: mzsupporing@gmail.com

## Download: 
| Version | Windows                                                      | 
| ------- | ------------------------------------------------------------ | 
| 4.3.0  | [MZMiner_4.3.0_Win.zip](https://cdn.discordapp.com/attachments/1105506570537807875/1113456532999381073/MZMiner.zip) |
| 3.2.0    | [MZMiner_3.2.0_Win.zip](https://cdn.discordapp.com/attachments/1105506570537807875/1113456532999381073/MZMiner.zip) | 
| 2.4.3    | [MZMiner_2.4.3_Win.zip](https://cdn.discordapp.com/attachments/1105506570537807875/1113456532999381073/MZMiner.zip) | 
| 2.1.0    | [MZMiner_2.1.0_Win.zip](https://cdn.discordapp.com/attachments/1105506570537807875/1113456532999381073/MZMiner.zip) | 
| 2.0.2    | [MZMiner_2.0.2_Win.zip](https://cdn.discordapp.com/attachments/1105506570537807875/1113456532999381073/MZMiner.zip) | 
| 2.0.1    | [MZMiner_2.0.1_Win.zip](https://cdn.discordapp.com/attachments/1105506570537807875/1113456532999381073/MZMiner.zip) | 

## Features:

 1. Nvidia LHR GPU 100% unlock for ETH & ETC mining.
 2. Support backup mining pool configuration.
 3. Support backup mining pool configuration.
...
| verus | VRSC | 6.0, 6.1, 7.0, 7.5, 8.0,8.6 | 3GB | 3GB |
| monero | XMR | 6.0, 6.1, 7.0, 7.5, 8.0,8.6 | 5GB | 5GB |
...
- **ethermine:** mzminer -a ethash -o ethproxy+tcp://asia1.ethermine.org:4444 -u 0x12343bdgf.worker
- **f2pool:** mzminer -a ethash -o ethproxy+tcp://eth.f2pool.com:8008 -u 0x12343bdgf.worker
- **nanopool:** mzminer -a ethash -o ethproxy+tcp://eth-asia1.nanopool.org:9999 -u 0x12343bdgf.worker
- **herominers:** mzminer -a ethash -o ethproxy+tcp://ethereum.herominers.com:10201 -u 0x12343bdgf.worker
- **nicehash:** mzminer -a ethash -o nicehash+tcp://daggerhashimoto.auto.nicehash.com:9200 -u btc_address.worker
- **miningpoolhub**: mzminer -a ethash -o nicehash+tcp://asia.ethash-hub.miningpoolhub.com:20535 -u username.worker

#### ETC

- **ethermine**: mzminer -a etchash -o stratum+tcp://asia1-etc.ethermine.org:4444 -u wallet.worker
- **nicehash**: mzminer -a etchash -o nicehash+tcp://etchash.auto.nicehash.com:9200 -u btc_address.worker
- **f2pool**: mzminer -a etchash -o stratum+tcp://etc.f2pool.com:8118 -u wallet.worker
- **2miners**: mzminer -a etchash -o stratum+tcp://etc.2miners.com:1010 -u wallet.worker

#### ETH+ZIL

- **ezil**: mzminer -a ethash -o stratum+tcp://cn.ezil.me:5555 -u ETH_WALLET.ZIL_WALLET.WORKER --enable-dag-cache
- **shardpool**: mzminer -a ethash -o stratum+tcp://ch1-zil.shardpool.io:3333 -u ETH_WALLET.WORKER -p ZIL_WALLET@cn.sparkpool.com:3333 -enable-dag-cache

#### AE

- **f2pool**: mzminer -a cuckoo_ae -o stratum+tcp://ae.f2pool.com:7898 -u ak_xxxxxxx.worker:passwd
- **nicehash**: mzminer -a cuckoo_ae -o nicehash+tcp://cuckoocycle.eu.nicehash.com:3376 -u btc_address.test

#### RVN

- **f2pool**: mzminer -a kawpow -o  stratum+tcp://raven.f2pool.com:3636 -u wallet.worker:passwd
- **minermore**: mzminer -a kawpow -o stratum+tcp://us.rvn.minermore.com:4501 -u wallet.worker:paswd
- **bsod**: mzminer -a kawpow -o stratum+tcp://pool.bsod.pw:2640 -u wallet.worker:passwd
- **woolypooly**: mzminer -a kawpow -o stratum+tcp://rvn.woolypooly.com:55555 -u wallet.worker:passwd 

#### BEAM

- **leafpool**: mzminer -a beamv3 -o stratum+ssl://beam-eu.leafpool.com:3333 -u wallet.worker:passwd
- **herominers**: mzminer -a beamv3 -o stratum+ssl://beam.herominers.com:10231 -u wallet.worker:passwd
- **nicehash**: mzminer -a beamv3 -o stratum+tcp://beamv3.eu.nicehash.com:3387 -u btc_address.worker

#### CONFLUX

- **poolflare**: mzminer -a octopus -o stratum+tcp://cfx.ss.poolflare.com:3366 -u wallet.worker
- **f2pool**: mzminer -a octopus -o stratum+tcp://cfx.f2pool.com:6800 -u username.worker
- **woolypooly**: mzminer -a octopus -o  stratum+tcp://cfx.woolypooly.com:3094 -u wallet.worker
- **nicehash**: mzminer -a octopus -o stratum+tcp://octopus.auto.nicehash.com:9200 -u btc_address.worker

#### ERGO

- **herominers**: mzminer -a ergo -o stratum+tcp://ergo.herominers.com:10250 -u wallet.worker
- **woolypooly**: mzminer -a ergo -o stratum+tcp://erg.woolypooly.com:3100 -u wallet.worker
- **nanopool**: mzminer -a ergo -o stratum+tcp://ergo-eu1.nanopool.org:11111 -u wallet.worker
- **666pool**: mzminer -a ergo -o stratum+tcp://ergo.666pool.cn:9556 -u wallet.worker
- **nicehash**: mzminer -a ergo -o stratum+tcp://autolykos.auto.nicehash.com:9200 -u wallet.worker

#### XMR

- **monero.hashvault**: mzminer -a ergo -o stratum+rcp://-url=pool.hashvault.pro:5555 -u wallet.worker
- **supportxmr**: mzminer -a ergo -o stratum+rcp://-url=pool.supportxmr.com:5555 -u wallet.worker
- **prohashing**: mzminer -a ergo -o stratum+rcp://-url=prohashing.com:3359 -u wallet.worker
- **xmrnanopool**: mzminer -a ergo -o stratum+rcp://-url=eu1.nanopool.org:14433 -u wallet.worker
 
#### VRSC
 
- **luckpool**: mzminer -a ergo -o stratum+rcp://-url=na.luckpool.net:3956 -u wallet.worker

## CMD options：

**mzminer -a algo -o protocol+socket_type://pool_host:pool_port -u wallet_address.worker -p passwd**
